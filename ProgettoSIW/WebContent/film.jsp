...
<html>
	<head>
		...
		<title>Golden Streaming - Film</title>
	    ...
	    <div class="container">			
		    ...
		    <div class="row searchFilmPosition">
			    ...
			    <div class="row jumbotron col-lg-12 searchFilm justify-content-center">
			        ...
			        <div class="row col-lg-9 catalogoFilm justify-content-center">Lista Film</div>
			    	
			    	<div class="row col-lg-3 justify-content-center">
	    				<a class="jumbotron linkPageBoxFilm" href="ottieniCercaFilm">Cerca un film</a>
					</div>
		    ...
		    <div class="row col-lg-12 paginationCharacter justify-content-center">
				  ...
				  <ul id="idItem" class="list-group list-group-horizontal">
				    ...
				    <!-- <li class="list-group-item"><a href="ottieniFilmPerCarattere?character=A">A</a></li> -->
