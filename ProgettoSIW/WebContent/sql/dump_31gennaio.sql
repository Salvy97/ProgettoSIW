...
--
-- Name: film; Type: TABLE; Schema: public; Owner: golden
--
...
CREATE TABLE public.film (
    ...
    filmato character varying(100)
);


ALTER TABLE public.film OWNER TO golden;
...
--
-- Data for Name: film; Type: TABLE DATA; Schema: public; Owner: golden
--

COPY public.film (id_film, titolo, anno, durata, genere, locandina, filmato) FROM stdin;
2641585	Ti	1222	123	assadfsdgdfg	asdsada	https://www.youtube.com/watch?v=L_n1rk-zI_Y&t=19s
...
1	p	83878C91171338902E0FE0FB97A8C47A	user	f	p@p.it\n
2	g	B2F5FF47436671B6E533D8DC3614845D	admin	t	p@g.it
\.
...
SELECT pg_catalog.setval('public.sottoscrizioni_id_seq', 26, true);
...
--
-- Name: film film_pkey; Type: CONSTRAINT; Schema: public; Owner: golden
--
...
--
-- Name: TABLE film; Type: ACL; Schema: public; Owner: golden
--

REVOKE ALL ON TABLE public.film FROM golden;
GRANT ALL ON TABLE public.film TO golden WITH GRANT OPTION;
