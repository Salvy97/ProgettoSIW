...
<html>
	<head>
		...
		<title>Golden Streaming - Cerca un Film</title>
	...
	<body>
	    ...
	    <div class="container">			
		    ...
		    <div class="row searchFilmPosition">
				
				<!-- Search form -->
			    <div class="row jumbotron col-lg-12 searchFilm justify-content-center">
				  
			        <div class="row col-lg-9 cercaFilm justify-content-center">Cerca un Film</div>
			    	
			    	<div class="row col-lg-3 justify-content-center">
	    				<a class="jumbotron linkPageBoxFilm" href="ottieniFilm">Lista film</a>
					</div>
					
					
					<div class="row jumbotron col-lg-11 justify-content-center searchBarFilm">
			    	
				        <div class="col-sm-3">
							<select class="form-control" id="idGender" name="gender" onchange="filmSearchGenderYear()">
								<option value="---">Film per Genere</option>
						...
						<div class="col-sm-2">
							<select id="idYear" name="year" class="form-control" onchange="filmSearchGenderYear()">
								<option value="0">film per anno</option>
						...
						<div>
							<div>
	  							<button class="btnSearch btn btn-secondary btn-sm" type="button" id="btnCercaPerTitolo" onclick="filmSearchTitle()">
						...
						<div class="col-sm-3 txtSearch">
							<div>
	  							<input class="form-control" type="text" name="title" placeholder="Regista..." id="idMovieDirector">
							</div>
						</div>
						<div>
							<div>
	  							<button class="btnSearch btn btn-secondary btn-sm" type="button" id="btnCercaPerRegista" onclick="filmSearchMovieDirector()">
	  								<i class="fa fa-search fa"></i>
	  							</button>
							</div>					
						</div>
